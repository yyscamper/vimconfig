...
exe "let s:bg_peru       = ' ".s:vmode."bg=".s:peru      ."'"
...
exe "let s:fg_peru       = ' ".s:vmode."fg=".s:peru      ."'"
...
if g:monokai_italic == 1
    exe "hi! Type"        .s:fg_purple      .s:bg_none        .s:fmt_ital
    exe "hi! Structure"   .s:fg_purple      .s:bg_none        .s:fmt_ital
    exe "hi! StorageClass".s:fg_purple      .s:bg_none        .s:fmt_ital
    exe "hi! Typedef"     .s:fg_purple      .s:bg_none        .s:fmt_ital
else
    exe "hi! Type"        .s:fg_purple      .s:bg_none        .s:fmt_none
    exe "hi! Structure"   .s:fg_purple      .s:bg_none        .s:fmt_none
    exe "hi! StorageClass".s:fg_purple      .s:bg_none        .s:fmt_none
...
" Javascript
exe "hi! jsFuncName"                .s:fg_blue          .s:bg_none          .s:fmt_none
exe "hi! jsFuncCall"                .s:fg_aqua          .s:bg_none          .s:fmt_none
exe "hi! jsThis"                    .s:fg_pink          .s:bg_none          .s:fmt_none
exe "hi! jsFunctionKey"             .s:fg_green         .s:bg_none          .s:fmt_none
exe "hi! jsFuncAssignIdent"         .s:fg_blue          .s:bg_none          .s:fmt_none
exe "hi! jsPrototype"               .s:fg_orange        .s:bg_none          .s:fmt_none
exe "hi! jsGlobalObjects"           .s:fg_peru          .s:bg_none          .s:fmt_none
exe "hi! jsExceptions"              .s:fg_aqua          .s:bg_none          .s:fmt_none
exe "hi! jsFutureKeys"              .s:fg_purple        .s:bg_none          .s:fmt_none
exe "hi! jsBuiltins"                .s:fg_purple        .s:bg_none          .s:fmt_none
exe "hi! jsBlockComment"            .s:fg_comment       .s:bg_none          .s:fmt_none
exe "hi! jsRegexpSpecial"            .s:fg_green       .s:bg_none          .s:fmt_none


if g:monokai_italic == 1
    exe "hi! jsFuncArgs"            .s:fg_orange        .s:bg_none          .s:fmt_ital
    exe "hi! jsFuncAssignObjChain"  .s:fg_blue          .s:bg_none          .s:fmt_ital
    exe "hi! jsStorageClass"        .s:fg_purple          .s:bg_none          .s:fmt_ital
    exe "hi! jsDocTags"             .s:fg_purple          .s:bg_none          .s:fmt_ital
	exe "hi! jsDocType"             .s:fg_comment          .s:bg_none          .s:fmt_ital
else
    exe "hi! jsFuncArgs"            .s:fg_foreground    .s:bg_none          .s:fmt_none
    exe "hi! jsFuncAssignObjChain"  .s:fg_blue          .s:bg_none          .s:fmt_none
    exe "hi! jsStorageClass"        .s:fg_purple          .s:bg_none          .s:fmt_none
    exe "hi! jsDocTags"             .s:fg_purple          .s:bg_none          .s:fmt_none
	exe "hi! jsDocType"             .s:fg_comment          .s:bg_none          .s:fmt_none
endif

exe "hi! javaScriptFunction"        .s:fg_blue          .s:bg_none          .s:fmt_none
exe "hi! javaScriptIdentifier"      .s:fg_purple          .s:bg_none          .s:fmt_none
exe "hi! javaScriptLabel"           .s:fg_purple          .s:bg_none          .s:fmt_none
exe "hi! javaScriptBraces"          .s:fg_none          .s:bg_none          .s:fmt_none

" JSON
exe "hi! jsonKeyword"          .s:fg_red          .s:bg_none          .s:fmt_none
exe "hi! jsonString"          .s:fg_green         .s:bg_none          .s:fmt_none
exe "hi! jsonBoolean"          .s:fg_aqua          .s:bg_none          .s:fmt_none
exe "hi! jsonNumber"          .s:fg_orange          .s:bg_none          .s:fmt_none
exe "hi! jsonNull"          .s:fg_comment          .s:bg_none          .s:fmt_none
exe "hi! jsonQuote"          .s:fg_comment          .s:bg_none          .s:fmt_none
